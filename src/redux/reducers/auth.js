import {
    AUTH_ERROR,
    LOGIN_FAILED, LOGIN_INITIATED, LOGIN_SUCCESS, LOGOUT_FAILED,
...
export default function reducer(state = initialState, action) {
    switch (action.type) {
        ...
        case AUTH_ERROR:
            if (action.payload && !action.payload.is_retriable) {
            ...
            return {
                ...
                user: null,
                token: action.payload.is_retriable ? state.token : null
            };
        ...
        case SIGNUP_SUCCESS:
            ...
            return {
                ...
                userForSignup: action.payload.user,
                token: action.payload.token,
                signupInitiated: false,
                lastUsedEmail: action.payload.user.email,
            };
